...
/**
 * Creates and bootstraps an Express application instance for testing.
 * Uses real AppContainer instance and registers the complete HTTP pipeline without listening.
 */
